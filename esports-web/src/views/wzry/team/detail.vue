<template>
  <div class="wzry-team-detail-page">
    ...
    <el-card v-loading="loading" shadow="never" class="team-detail-card">
      <div class="team-header">
        ...
        <div class="team-actions">
          <el-button type="primary" v-if="isLeader" @click="$router.push('/wzry/team/manage')">管理战队</el-button>
    ...
    <el-card v-if="recentMatches.length > 0" shadow="never" class="recent-matches-card" style="margin-top: 30px;">
      <template #header>
        <div class="card-header">
          <h3>近期约战</h3>
          <el-button link @click="$router.push('/wzry/match')">查看全部</el-button>
        </div>
      </template>
...
const goToMatchDetail = (matchId) => {
  router.push(`/wzry/match/${matchId}`);
};
